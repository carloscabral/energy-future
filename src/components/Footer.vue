            ...
            <div class="row align-items-start" style="margin-top: 4.5rem;">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <ul class="footer-menu__list">
                        ...
                        <li style="line-height: 1.5 !important; margin-top: .45rem;" class="footer-menu__item"><g-link style="line-height: 1.5 !important;" to="../assets/images/Regulamento_EF_Prorrogacao-de-Inscricao.pdf" target="_blank">Regulamento Energy Future - Prorrogação das inscrições</g-link></li>
                    </ul>                
                </div>
