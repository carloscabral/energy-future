          ...
          <div class="row">
              <div class="col-xl-3 col-lg-6 col-md-6 mt-5 px-xl-2">
                  <div class="card card--1">
                      ...
                      <g-link to="../assets/images/Aditivo-ao-Regulamento-MakeAB.pdf" target="_blank" class="card__link card__link--1"><font-awesome :icon="['fas', 'arrow-right']"/>Aditivo ao Regulamento</g-link>
